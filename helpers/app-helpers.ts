...
export const automatismosCambiarComprobantesInternos = async() => {
    ...
    if(receptor && receptor_placa){
        ...
        const { hasErrorComprobante, messageComprobante, comprobante} = await nuevoComprobante(interno.id_abastecimiento, Constantes.TipoComprobante.Factura, receptor, correlativo, receptor_placa.placa, emisor_id, interno.dec_combustible, interno.numeracion_comprobante, "", "", "", 0, interno.pago_efectivo, 0, 0);
